...
def test_login_con_password_giusta(client):
    registra(client, "Azienda A", "Marco", "marco@a.it", password="segreta")
    r = client.post("/auth/login", json={"email": "marco@a.it", "password": "segreta"})
